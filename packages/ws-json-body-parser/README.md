<div align="center">
  ...
  <p><strong>WebSocket json body parser middleware for the middy framework, the stylish Node.js middleware engine for AWS Lambda</strong></p>
  <p>
    ...
    <br/>
    <a href="https://www.npmjs.com/package/@middy/ws-json-body-parser"><img alt="npm version" src="https://img.shields.io/npm/v/@middy/ws-json-body-parser.svg"></a>
    <a href="https://packagephobia.com/result?p=@middy/ws-json-body-parser"><img src="https://packagephobia.com/badge?p=@middy/ws-json-body-parser" alt="npm install size"></a>
    <a href="https://www.npmjs.com/package/@middy/ws-json-body-parser">
    <img alt="npm weekly downloads" src="https://img.shields.io/npm/dw/@middy/ws-json-body-parser.svg"></a>
    <a href="https://www.npmjs.com/package/@middy/ws-json-body-parser#provenance">
...
For documentation and examples, refers to the main [Middy monorepo on GitHub](https://github.com/middyjs/middy) or [Middy official website](https://middy.js.org/docs/middlewares/ws-json-body-parser).
