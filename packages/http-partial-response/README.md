<div align="center">
  ...
  <p>
    ...
    <br/>
    <a href="https://www.npmjs.com/package/@middy/http-partial-response"><img alt="npm version" src="https://img.shields.io/npm/v/@middy/http-partial-response.svg"></a>
    <a href="https://packagephobia.com/result?p=@middy/http-partial-response"><img src="https://packagephobia.com/badge?p=@middy/http-partial-response" alt="npm install size"></a>
    <a href="https://www.npmjs.com/package/@middy/http-partial-response">
    <img alt="npm weekly downloads" src="https://img.shields.io/npm/dw/@middy/http-partial-response.svg"></a>
    <a href="https://www.npmjs.com/package/@middy/http-partial-response#provenance">
...
For documentation and examples, refers to the main [Middy monorepo on GitHub](https://github.com/middyjs/middy) or [Middy official website](https://middy.js.org/docs/middlewares/http-partial-response).
