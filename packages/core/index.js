 ...
 * @property {pluginFunction} beforePrefetch - request hook for *beforePrefetch*
 * @property {pluginFunction} requestStart - request hook for *beforePrefetch*
 * @property {pluginMiddlewareFunction} beforeMiddleware - request hook for *beforeMiddleware*
 * @property {pluginMiddlewareFunction} afterMiddleware - request hook for *afterMiddleware*
 * @property {pluginFunction} beforeHandler - request hook for *beforeHandler*
 * @property {pluginFunction} afterHandler - request hook for *afterHandler*
 * @property {pluginRequestEndFunction} requestEnd - request hook for *beforePrefetch*
 */
...
/**
 * @typedef {function} pluginMiddlewareFunction
 * @param {string} id - unique identifier for hook
 * @return {void}
 */

/**
 * @typedef {function} pluginRequestEndFunction
 * @return {void|Promise}
 */

/**
 * @typedef {function} middy
