<div align="center">
  <h1>Middy `error-logger` middleware</h1>
  ...
  <p>
    ...
    <br/>
    <a href="https://www.npmjs.com/package/@middy/error-logger"><img alt="npm version" src="https://img.shields.io/npm/v/@middy/error-logger.svg"></a>
    <a href="https://packagephobia.com/result?p=@middy/error-logger"><img src="https://packagephobia.com/badge?p=@middy/error-logger" alt="npm install size"></a>
    <a href="https://www.npmjs.com/package/@middy/error-logger">
    <img alt="npm weekly downloads" src="https://img.shields.io/npm/dw/@middy/error-logger.svg"></a>
    <a href="https://www.npmjs.com/package/@middy/error-logger#provenance">
...
For documentation and examples, refers to the main [Middy monorepo on GitHub](https://github.com/middyjs/middy) or [Middy official website](https://middy.js.org/docs/middlewares/error-logger).
