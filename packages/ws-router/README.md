<div align="center">
  ...
  <p>
    ...
    <br/>
    <a href="https://www.npmjs.com/package/@middy/ws-router"><img alt="npm version" src="https://img.shields.io/npm/v/@middy/ws-router.svg"></a>
    <a href="https://packagephobia.com/result?p=@middy/ws-router"><img src="https://packagephobia.com/badge?p=@middy/ws-router" alt="npm install size"></a>
    <a href="https://www.npmjs.com/package/@middy/ws-router">
    <img alt="npm weekly downloads" src="https://img.shields.io/npm/dw/@middy/ws-router.svg"></a>
    <a href="https://www.npmjs.com/package/@middy/ws-router#provenance">
...
For documentation and examples, refers to the main [Middy monorepo on GitHub](https://github.com/middyjs/middy) or [Middy official website](https://middy.js.org/docs/routers/ws-router).
