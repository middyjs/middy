<div align="center">
  ...
  <p>
    ...
    <br/>
    <a href="https://www.npmjs.com/package/@middy/sqs-partial-batch-failure"><img alt="npm version" src="https://img.shields.io/npm/v/@middy/sqs-partial-batch-failure.svg"></a>
    <a href="https://packagephobia.com/result?p=@middy/sqs-partial-batch-failure"><img src="https://packagephobia.com/badge?p=@middy/sqs-partial-batch-failure" alt="npm install size"></a>
    <a href="https://www.npmjs.com/package/@middy/sqs-partial-batch-failure">
    <img alt="npm weekly downloads" src="https://img.shields.io/npm/dw/@middy/sqs-partial-batch-failure.svg"></a>
    <a href="https://www.npmjs.com/package/@middy/sqs-partial-batch-failure#provenance">
...
For documentation and examples, refers to the main [Middy monorepo on GitHub](https://github.com/middyjs/middy) or [Middy official website](https://middy.js.org/docs/middlewares/sqs-partial-batch-failure).
