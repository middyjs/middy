<div align="center">
  <h1>Middy `event-batch-handler` helper</h1>
  <img alt="Middy logo" src="https://raw.githubusercontent.com/middyjs/middy/main/docs/img/middy-logo.svg"/>
  <p><strong>Per-record handler wrapper for Lambda batch events. Auto-checkpoints under Durable Functions. Pairs with <code>@middy/event-batch-response</code>.</strong></p>
  <p>
    ...
    <br/>
    <a href="https://www.npmjs.com/package/@middy/event-batch-handler"><img alt="npm version" src="https://img.shields.io/npm/v/@middy/event-batch-handler.svg"></a>
    <a href="https://packagephobia.com/result?p=@middy/event-batch-handler"><img src="https://packagephobia.com/badge?p=@middy/event-batch-handler" alt="npm install size"></a>
    <a href="https://www.npmjs.com/package/@middy/event-batch-handler">
    <img alt="npm weekly downloads" src="https://img.shields.io/npm/dw/@middy/event-batch-handler.svg"></a>
    <a href="https://www.npmjs.com/package/@middy/event-batch-handler#provenance">
...
<p>You can read the documentation at: <a href="https://middy.js.org/docs/handlers/event-batch-handler">https://middy.js.org/docs/handlers/event-batch-handler</a></p>
</div>
...
For documentation and examples, refer to the main [Middy monorepo on GitHub](https://github.com/middyjs/middy) or [Middy official website](https://middy.js.org/docs/handlers/event-batch-handler).
