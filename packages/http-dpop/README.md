<div align="center">
  <h1>Middy `http-dpop` middleware</h1>
  <img alt="Middy logo" src="https://raw.githubusercontent.com/middyjs/middy/main/docs/img/middy-logo.svg"/>
  <p><strong>HTTP DPoP (RFC 9449) sender-constrained token middleware for the middy framework, the stylish Node.js middleware engine for AWS Lambda</strong></p>
<p>
    ...
    <br/>
    <a href="https://www.npmjs.com/package/@middy/http-dpop"><img alt="npm version" src="https://img.shields.io/npm/v/@middy/http-dpop.svg"></a>
    <a href="https://packagephobia.com/result?p=@middy/http-dpop"><img src="https://packagephobia.com/badge?p=@middy/http-dpop" alt="npm install size"></a>
    <a href="https://www.npmjs.com/package/@middy/http-dpop">
    <img alt="npm weekly downloads" src="https://img.shields.io/npm/dw/@middy/http-dpop.svg"></a>
    <a href="https://www.npmjs.com/package/@middy/http-dpop#provenance">
...
<p>You can read the documentation at: <a href="https://middy.js.org/docs/middlewares/http-dpop">https://middy.js.org/docs/middlewares/http-dpop</a></p>
</div>
...
For documentation and examples, refer to the main [Middy monorepo on GitHub](https://github.com/middyjs/middy) or [Middy official website](https://middy.js.org/docs/middlewares/http-dpop).
