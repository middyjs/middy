...
<p>
    ...
    <br/>
    <a href="https://www.npmjs.com/package/@middy/cloudwatch-metrics"><img alt="npm version" src="https://img.shields.io/npm/v/@middy/cloudwatch-metrics.svg"></a>
    <a href="https://packagephobia.com/result?p=@middy/cloudwatch-metrics"><img src="https://packagephobia.com/badge?p=@middy/cloudwatch-metrics" alt="npm install size"></a>
    <a href="https://www.npmjs.com/package/@middy/cloudwatch-metrics">
    <img alt="npm weekly downloads" src="https://img.shields.io/npm/dw/@middy/cloudwatch-metrics.svg"></a>
    <a href="https://www.npmjs.com/package/@middy/cloudwatch-metrics#provenance">
...
For documentation and examples, refer to the main [Middy monorepo on GitHub](https://github.com/middyjs/middy) or [Middy official website](https://middy.js.org/docs/middlewares/cloudwatch-metrics).
