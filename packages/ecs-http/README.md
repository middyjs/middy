<div align="center">
  <h1>Middy `ecs-http` server</h1>
  <img alt="Middy logo" src="https://raw.githubusercontent.com/middyjs/middy/main/docs/img/middy-logo.svg"/>
  <p><strong>ECS/Fargate HTTP server runtime for the middy framework, the stylish Node.js middleware engine for AWS Lambda</strong></p>
  <p>
    ...
    <br/>
    <a href="https://www.npmjs.com/package/@middy/ecs-http"><img alt="npm version" src="https://img.shields.io/npm/v/@middy/ecs-http.svg"></a>
    <a href="https://packagephobia.com/result?p=@middy/ecs-http"><img src="https://packagephobia.com/badge?p=@middy/ecs-http" alt="npm install size"></a>
    <a href="https://www.npmjs.com/package/@middy/ecs-http">
    <img alt="npm weekly downloads" src="https://img.shields.io/npm/dw/@middy/ecs-http.svg"></a>
    <a href="https://www.npmjs.com/package/@middy/ecs-http#provenance">
