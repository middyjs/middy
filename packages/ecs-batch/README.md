<div align="center">
  <h1>Middy `ecs-batch` runner</h1>
  <img alt="Middy logo" src="https://raw.githubusercontent.com/middyjs/middy/main/docs/img/middy-logo.svg"/>
  <p><strong>ECS/Fargate batch event runtime for the middy framework, the stylish Node.js middleware engine for AWS Lambda</strong></p>
  <p>
    ...
    <br/>
    <a href="https://www.npmjs.com/package/@middy/ecs-batch"><img alt="npm version" src="https://img.shields.io/npm/v/@middy/ecs-batch.svg"></a>
    <a href="https://packagephobia.com/result?p=@middy/ecs-batch"><img src="https://packagephobia.com/badge?p=@middy/ecs-batch" alt="npm install size"></a>
    <a href="https://www.npmjs.com/package/@middy/ecs-batch">
    <img alt="npm weekly downloads" src="https://img.shields.io/npm/dw/@middy/ecs-batch.svg"></a>
    <a href="https://www.npmjs.com/package/@middy/ecs-batch#provenance">
...
<p>You can read the documentation at: <a href="https://middy.js.org/docs/runners/ecs-batch">https://middy.js.org/docs/runners/ecs-batch</a></p>
</div>
...
For documentation and examples, refer to the main [Middy monorepo on GitHub](https://github.com/middyjs/middy) or [Middy official website](https://middy.js.org/docs/runners/ecs-batch).
