<div align="center">
  ...
  <p>
    ...
    <br/>
    <a href="https://www.npmjs.com/package/@middy/secrets-manager"><img alt="npm version" src="https://img.shields.io/npm/v/@middy/secrets-manager.svg"></a>
    <a href="https://packagephobia.com/result?p=@middy/secrets-manager"><img src="https://packagephobia.com/badge?p=@middy/secrets-manager" alt="npm install size"></a>
    <a href="https://www.npmjs.com/package/@middy/secrets-manager">
    <img alt="npm weekly downloads" src="https://img.shields.io/npm/dw/@middy/secrets-manager.svg"></a>
    <a href="https://www.npmjs.com/package/@middy/secrets-manager#provenance">
...
For documentation and examples, refers to the main [Middy monorepo on GitHub](https://github.com/middyjs/middy) or [Middy official website](https://middy.js.org/docs/middlewares/secrets-manager).
