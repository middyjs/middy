<div align="center">
  <h1>Middy `ssm-extension` middleware</h1>
  <img alt="Middy logo" src="https://raw.githubusercontent.com/middyjs/middy/main/docs/img/middy-logo.svg"/>
  <p><strong>SSM Parameter Store Lambda Extension middleware for the middy framework, the stylish Node.js middleware engine for AWS Lambda</strong></p>
<p>
    ...
    <br/>
    <a href="https://www.npmjs.com/package/@middy/ssm-extension"><img alt="npm version" src="https://img.shields.io/npm/v/@middy/ssm-extension.svg"></a>
    <a href="https://packagephobia.com/result?p=@middy/ssm-extension"><img src="https://packagephobia.com/badge?p=@middy/ssm-extension" alt="npm install size"></a>
    <a href="https://www.npmjs.com/package/@middy/ssm-extension">
    <img alt="npm weekly downloads" src="https://img.shields.io/npm/dw/@middy/ssm-extension.svg"></a>
    <a href="https://www.npmjs.com/package/@middy/ssm-extension#provenance">
...
<p>You can read the documentation at: <a href="https://middy.js.org/docs/middlewares/ssm-extension">https://middy.js.org/docs/middlewares/ssm-extension</a></p>
</div>
...
For documentation and examples, refer to the main [Middy monorepo on GitHub](https://github.com/middyjs/middy) or [Middy official website](https://middy.js.org/docs/middlewares/ssm-extension).
