<div align="center">
  ...
  <p><strong>HTTP multipart body parser middleware for the middy framework, the stylish Node.js middleware engine for AWS Lambda</strong></p>
<p>
    ...
    <br/>
    <a href="https://www.npmjs.com/package/@middy/http-multipart-body-parser"><img alt="npm version" src="https://img.shields.io/npm/v/@middy/http-multipart-body-parser.svg"></a>
    <a href="https://packagephobia.com/result?p=@middy/http-multipart-body-parser"><img src="https://packagephobia.com/badge?p=@middy/http-multipart-body-parser" alt="npm install size"></a>
    <a href="https://www.npmjs.com/package/@middy/http-multipart-body-parser">
    <img alt="npm weekly downloads" src="https://img.shields.io/npm/dw/@middy/http-multipart-body-parser.svg"></a>
    <a href="https://www.npmjs.com/package/@middy/http-multipart-body-parser#provenance">
