<div align="center">
  <h1>Middy `http-x402` middleware</h1>
  <img alt="Middy logo" src="https://raw.githubusercontent.com/middyjs/middy/main/docs/img/middy-logo.svg"/>
  <p><strong>x402 payment middleware for the middy framework, the stylish Node.js middleware engine for AWS Lambda</strong></p>
<p>
    ...
    <br/>
    <a href="https://www.npmjs.com/package/@middy/http-x402"><img alt="npm version" src="https://img.shields.io/npm/v/@middy/http-x402.svg"></a>
    <a href="https://packagephobia.com/result?p=@middy/http-x402"><img src="https://packagephobia.com/badge?p=@middy/http-x402" alt="npm install size"></a>
    <a href="https://www.npmjs.com/package/@middy/http-x402">
    <img alt="npm weekly downloads" src="https://img.shields.io/npm/dw/@middy/http-x402.svg"></a>
    <a href="https://www.npmjs.com/package/@middy/http-x402#provenance">
...
<p>You can read the documentation at: <a href="https://middy.js.org/docs/middlewares/http-x402">https://middy.js.org/docs/middlewares/http-x402</a></p>
</div>

## Install

```bash
npm install --save @middy/http-x402
```


## Documentation and examples

For documentation and examples, refer to the main [Middy monorepo on GitHub](https://github.com/middyjs/middy) or [Middy official website](https://middy.js.org/docs/middlewares/http-x402).
