<div align="center">
  <h1>Middy OpenTelemetry Protocol Metrics</h1>
  <img alt="Middy logo" src="https://raw.githubusercontent.com/middyjs/middy/main/docs/img/middy-logo.svg"/>
  <p><strong>OpenTelemetry Protocol Metrics middleware for the middy framework, the stylish Node.js middleware engine for AWS Lambda</strong></p>
  <p>
    ...
    <br/>
    <a href="https://www.npmjs.com/package/@middy/otlp-metrics"><img alt="npm version" src="https://img.shields.io/npm/v/@middy/otlp-metrics.svg"></a>
    <a href="https://packagephobia.com/result?p=@middy/otlp-metrics"><img src="https://packagephobia.com/badge?p=@middy/otlp-metrics" alt="npm install size"></a>
    <a href="https://www.npmjs.com/package/@middy/otlp-metrics">
    <img alt="npm weekly downloads" src="https://img.shields.io/npm/dw/@middy/otlp-metrics.svg"></a>
    <a href="https://www.npmjs.com/package/@middy/otlp-metrics#provenance">
...
<p>You can read the documentation at: <a href="https://middy.js.org/docs/middlewares/otlp-metrics">https://middy.js.org/docs/middlewares/otlp-metrics</a></p>
</div>
