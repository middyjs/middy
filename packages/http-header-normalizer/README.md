...
<p>
    ...
    <br/>
    <a href="https://www.npmjs.com/package/@middy/http-header-normalizer"><img alt="npm version" src="https://img.shields.io/npm/v/@middy/http-header-normalizer.svg"></a>
    <a href="https://packagephobia.com/result?p=@middy/http-header-normalizer"><img src="https://packagephobia.com/badge?p=@middy/http-header-normalizer" alt="npm install size"></a>
    <a href="https://www.npmjs.com/package/@middy/http-header-normalizer">
    <img alt="npm weekly downloads" src="https://img.shields.io/npm/dw/@middy/http-header-normalizer.svg"></a>
    <a href="https://www.npmjs.com/package/@middy/http-header-normalizer#provenance">
...
For documentation and examples, refers to the main [Middy monorepo on GitHub](https://github.com/middyjs/middy) or [Middy official website](https://middy.js.org/docs/middlewares/http-header-normalizer).
