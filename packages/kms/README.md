<div align="center">
  <h1>Middy `kms` middleware</h1>
  <img alt="Middy logo" src="https://raw.githubusercontent.com/middyjs/middy/main/docs/img/middy-logo.svg"/>
  <p><strong>KMS (Key Management Service) middleware for the middy framework, the stylish Node.js middleware engine for AWS Lambda</strong></p>
<p>
    ...
    <br/>
    <a href="https://www.npmjs.com/package/@middy/kms"><img alt="npm version" src="https://img.shields.io/npm/v/@middy/kms.svg"></a>
    <a href="https://packagephobia.com/result?p=@middy/kms"><img src="https://packagephobia.com/badge?p=@middy/kms" alt="npm install size"></a>
    <a href="https://www.npmjs.com/package/@middy/kms">
    <img alt="npm weekly downloads" src="https://img.shields.io/npm/dw/@middy/kms.svg"></a>
    <a href="https://www.npmjs.com/package/@middy/kms#provenance">
...
<p>You can read the documentation at: <a href="https://middy.js.org/docs/middlewares/kms">https://middy.js.org/docs/middlewares/kms</a></p>
</div>
...
For documentation and examples, refer to the main [Middy monorepo on GitHub](https://github.com/middyjs/middy) or [Middy official website](https://middy.js.org/docs/middlewares/kms).
