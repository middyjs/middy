<div align="center">
  <h1>Middy `http-paseto` middleware</h1>
  <img alt="Middy logo" src="https://raw.githubusercontent.com/middyjs/middy/main/docs/img/middy-logo.svg"/>
  <p><strong>HTTP PASETO authentication middleware for the middy framework, the stylish Node.js middleware engine for AWS Lambda</strong></p>
<p>
    ...
    <br/>
    <a href="https://www.npmjs.com/package/@middy/http-paseto"><img alt="npm version" src="https://img.shields.io/npm/v/@middy/http-paseto.svg"></a>
    <a href="https://packagephobia.com/result?p=@middy/http-paseto"><img src="https://packagephobia.com/badge?p=@middy/http-paseto" alt="npm install size"></a>
    <a href="https://www.npmjs.com/package/@middy/http-paseto">
    <img alt="npm weekly downloads" src="https://img.shields.io/npm/dw/@middy/http-paseto.svg"></a>
    <a href="https://www.npmjs.com/package/@middy/http-paseto#provenance">
...
<p>You can read the documentation at: <a href="https://middy.js.org/docs/middlewares/http-paseto">https://middy.js.org/docs/middlewares/http-paseto</a></p>
</div>
...
For documentation and examples, refer to the main [Middy monorepo on GitHub](https://github.com/middyjs/middy) or [Middy official website](https://middy.js.org/docs/middlewares/http-paseto).
