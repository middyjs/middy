<div align="center">
  <h1>Middy OpenTelemetry Protocol Logger</h1>
  <img alt="Middy logo" src="https://raw.githubusercontent.com/middyjs/middy/main/docs/img/middy-logo.svg"/>
  <p><strong>OpenTelemetry Protocol Logger middleware for the middy framework, the stylish Node.js middleware engine for AWS Lambda</strong></p>
  <p>
    ...
    <br/>
    <a href="https://www.npmjs.com/package/@middy/otlp-logger"><img alt="npm version" src="https://img.shields.io/npm/v/@middy/otlp-logger.svg"></a>
    <a href="https://packagephobia.com/result?p=@middy/otlp-logger"><img src="https://packagephobia.com/badge?p=@middy/otlp-logger" alt="npm install size"></a>
    <a href="https://www.npmjs.com/package/@middy/otlp-logger">
    <img alt="npm weekly downloads" src="https://img.shields.io/npm/dw/@middy/otlp-logger.svg"></a>
    <a href="https://www.npmjs.com/package/@middy/otlp-logger#provenance">
...
<p>You can read the documentation at: <a href="https://middy.js.org/docs/middlewares/otlp-logger">https://middy.js.org/docs/middlewares/otlp-logger</a></p>
</div>
