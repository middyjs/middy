<div align="center">
  ...
  <p>
    ...
    <br/>
    <a href="https://www.npmjs.com/package/@middy/http-response-serializer"><img alt="npm version" src="https://img.shields.io/npm/v/@middy/http-response-serializer.svg"></a>
    <a href="https://packagephobia.com/result?p=@middy/http-response-serializer"><img src="https://packagephobia.com/badge?p=@middy/http-response-serializer" alt="npm install size"></a>
    <a href="https://www.npmjs.com/package/@middy/http-response-serializer">
    <img alt="npm weekly downloads" src="https://img.shields.io/npm/dw/@middy/http-response-serializer.svg"></a>
    <a href="https://www.npmjs.com/package/@middy/http-response-serializer#provenance">
...
For documentation and examples, refers to the main [Middy monorepo on GitHub](https://github.com/middyjs/middy) or [Middy official website](https://middy.js.org/docs/middlewares/http-response-serializer).
