<div align="center">
  <h1>Middy `event-normalizer` middleware</h1>
  ...
  <p>
    ...
    <br/>
    <a href="https://www.npmjs.com/package/@middy/event-normalizer"><img alt="npm version" src="https://img.shields.io/npm/v/@middy/event-normalizer.svg"></a>
    <a href="https://packagephobia.com/result?p=@middy/event-normalizer"><img src="https://packagephobia.com/badge?p=@middy/event-normalizer" alt="npm install size"></a>
    <a href="https://www.npmjs.com/package/@middy/event-normalizer">
    <img alt="npm weekly downloads" src="https://img.shields.io/npm/dw/@middy/event-normalizer.svg"></a>
    <a href="https://www.npmjs.com/package/@middy/event-normalizer#provenance">
...
For documentation and examples, refers to the main [Middy monorepo on GitHub](https://github.com/middyjs/middy) or [Middy official website](https://middy.js.org/docs/middlewares/event-normalizer).
