...
- Support for `--experimental-require-module`. Introduced into nodejs 20.17 this allows for the import of ESM in CJS codebases making the migration to ESM easier.
